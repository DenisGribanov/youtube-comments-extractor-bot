...
cp -f ~/gitlab/youtube-comments-extractor-bot/YoutubeCommentsExtractorBot/BotApi/Dockerfile ~/gitlab/youtube-comments-extractor-bot/Dockerfile

docker build -t comments_extractor_bot_v2:v.0.1 gitlab/youtube-comments-extractor-bot/YoutubeCommentsExtractorBot

docker run -v ~/commentsextractor_files:/app/files --name comments_extractor_bot_v2 -d -p 8587:8080 comments_extractor_bot_v2:v.0.1
